...
class Mover {
  ...
  update() {
    this.acceleration = p5.Vector.random2D(); // The random2D() function will give us a unit vector pointing in a random direction
    // this.acceleration.mult(0.5); // scaling the acceleration vector to a constant value
    // this.acceleration.mult(random(3)); // scaling the acceleration vector to a random value
    this.acceleration.mult(noise(0,3)); // scaling the acceleration vector to a Perlin noise value
